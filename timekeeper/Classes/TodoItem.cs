    ...
    public class TodoItem
    {
        ...
        public bool Create()
        {
            try {
                ...
                TodoItem["StartTime"] = Timekeeper.DateForDatabase(this.StartTime);
                TodoItem["DueTime"] = Timekeeper.DateForDatabase(this.DueTime);
        ...
        public void Unhide()
        {
            ...
            this.IsHidden = false;
            this.HiddenTime = DateTimeOffset.MinValue;
        }
