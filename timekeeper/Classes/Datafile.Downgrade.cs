...
namespace Timekeeper
{
    partial class Datafile
    {
        ...
        public void SaveAs22(Datafile newDatafile)
        {
            ...
            newDatafile.Data.Exec("drop table meta");
            newDatafile.CreateMeta(Version, true);
            ...
            // Activity table
            Table Activity = this.Data.Select("select * from Activity");
            foreach (Row Row in Activity) {
                ...
                newDatafile.Data.Insert("tasks", NewRow);
            }

            // Project table
            Table Project = this.Data.Select("select * from Project");
            foreach (Row Row in Project) {
                ...
                newDatafile.Data.Insert("projects", NewRow);
            }

            // Journal table
            Table Journal = this.Data.Select("select * from Journal");
            foreach (Row Row in Journal) {
                ...
                newDatafile.Data.Insert("timekeeper", NewRow);
            }

            // Diary table
            Table Diary = this.Data.Select("select * from Diary");
            foreach (Row Row in Diary) {
                ...
                newDatafile.Data.Insert("journal", NewRow);
            }

            // GridOptions table
            Table GridOptions = this.Data.Select("select * from GridOptions");
            foreach (Row Row in GridOptions) {
                ...
                newDatafile.Data.Insert("grid_views", NewRow);
            }
        }
